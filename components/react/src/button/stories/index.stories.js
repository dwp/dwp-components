...
stories.add('With an Icon', withInfo(doc)(() => (
  <Button icon={iconPath}>Click here</Button>
)));

stories.add('Disabled', withInfo(doc)(() => (
  <Button disabled>Click here</Button>
)));

stories.add('As a link', withInfo(doc)(() => (
  <Button as="a" href="#">Click here</Button>
)));
