...
stories.add(
  'Exclamation Mark',
  withInfo(doc)(() => <Warning>You can be fined up to if you don’t register.</Warning>)
);

stories.add(
  'Question Mark',
  withInfo(doc)(() => (
    <Warning icon="?" assistiveText="Question">
      Have you checked your bank account details?
    </Warning>
  ))
);
