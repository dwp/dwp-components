  ...
  <Frame>
    ...
    <Graph>
      <FlexiblePlot xType="time" height={400}>
        ...
        <XAxis tickFormat={d => moment(d).format('MMM YY')} tickTotal={6} tickSize={0} hideLine style={{
          text: { fill: Theme.palette.common.text }
        }} />
        <YAxis tickSize={0} hideLine style={{
          text: { fill: Theme.palette.common.text }
        }} />
        <LineSeries color={Theme.palette.display.blue} style={{strokeWidth: 3}}
          data={[
